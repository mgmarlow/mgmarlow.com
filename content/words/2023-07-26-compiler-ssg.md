...
With this in mind, I ditched the prior code in favor of a more
...
The ability to pend evaluation by quoting is incredibly useful for a
...
If an alist is passed into `eval` it uses it as the lexical
